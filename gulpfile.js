...
var cssTasks = function(filename) {
  ...
  .pipe(function() {
    return gulpif('*.scss', sass({
        ...
        includePaths: [
       './node_modules/compass-mixins/lib' // include compass mixins
       ],
       precision: 10,
...
// ### Sprites
// `gulp sprites` - creates sprites of images used in template

gulp.task('sprite', function() {
 var spriteData =
      gulp.src('./assets/sprites/*.png') // source path of the sprite images
      .pipe(spritesmith({
...
gulp.task('watch', function() {
  ...
  gulp.watch([path.source + '../lib/extensions/**/*.scss'], ['styles']);
  gulp.watch([path.source + 'scripts/**/*'], ['jshint', 'scripts']);
  gulp.watch([path.source + '../lib/extensions/**/*.js'], ['jshint', 'scripts']);
  gulp.watch([path.source + 'fonts/**/*'], ['fonts']);
  gulp.watch([path.source + 'images/**/*'], ['images']);
  gulp.watch([path.source + 'sprites/**/*'], ['sprite', 'images', 'styles' ]);
